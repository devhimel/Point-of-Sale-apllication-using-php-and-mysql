    ...
    <script>
        $(document).ready(function () {
            ...
            function fetchCustomers() {
                $.ajax({
                    url: "user_code.php?action=fetchCustomers",
                    method: "POST",
                    dataType: "json",
            ...
            $('#insertForm').on('submit', function (e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "user_code.php?action=insertCustomer",
                    method: "POST",
            ...
            $('#categoryTable').on('click', '.editBtn', function () {
                var id = $(this).val();
                $.ajax({
                    url: "user_code.php?action=fetchSingleCustomer",
                    method: "POST",
                    dataType: "json",
                    data: {id: id},
                    success: function (response) {
            ...
            $('#editForm').on('submit', function (e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "user_code.php?action=updateCustomer",
                    method: "POST",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
            ...
            $('#categoryTable').on('click', '.deleteBtn', function () {
                if(confirm("Are you sure you want to delete this customer?")) {
                    var id = $(this).val();
                    $.ajax({
                        url: "user_code.php?action=deleteSingleCustomer",
                        method: "POST",
                        dataType: "json",
                        data: {id: id},
                        success: function (response) {
