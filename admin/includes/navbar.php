        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="./assets/images/users/<?php echo $_SESSION['loggedInUser']['avatar']; ?>" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="./assets/images/users/<?php echo $_SESSION['loggedInUser']['avatar']; ?>" alt="">
                        </div>
                        <div class="text-center">
                            <p class="tx-16 fw-bolder"> <?php echo $_SESSION['loggedInUser']['first_name'] .' '. $_SESSION['loggedInUser']['last_name']; ?> </p>
                            <p class="tx-12 text-muted"><?php echo $_SESSION['loggedInUser']['email']; ?></p>
                        </div>
                    </div>
